...
export const BookConverter = () => {
  ...
  const onDrop = async (acceptedFiles) => {
    ...
    try {
      ...
      if (file.type === 'text/plain') {
        ...
        throw new Error('Unsupported file type. Use text files (.txt) or Word documents (.docx).');
      }
  ...
  return (
    <div className="converter-container">
      ...
      <p>Upload a text file (.txt) or Word document (.docx) to convert to PDF.</p>
      <p><small>Converts with high fidelity, preserving original formatting and fonts.</small></p>
