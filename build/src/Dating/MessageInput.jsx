...
export const MessageInput = ({ setShowIcebreakerModal, setShowGiftModal }) => {
  ...
  const wrapSelection = wrapSelectionFactory(newMessage, setNewMessage, inputRef, setShowFormatToolbar, setShowHighlightPalette, selectionStart, selectionEnd);
...
function wrapSelectionFactory(newMessage, setNewMessage, inputRef, setShowFormatToolbar, setShowHighlightPalette, selectionStart, selectionEnd) {
