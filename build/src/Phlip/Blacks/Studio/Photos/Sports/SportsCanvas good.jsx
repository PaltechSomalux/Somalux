...
export const SportsCanvas = ({
  ...
  startLongPress,
  handleTextBlur,
  handleTextKeyDown, // This will be overridden
  handleTouchZoom,
  setCanvasRefs,
  updateText,
  ...
  // Define updateTextProperties to update text dimensions
  const updateTextProperties = useCallback((id, updates) => {
    setTexts((prev) => prev.map((text) => (text.id === id ? { ...text, ...updates } : text)));
  }, [setTexts]);

  // Override handleTextKeyDown to support multi-line text input
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SportsTextElements
          texts={texts}
          setTexts={setTexts} // Added to allow direct state updates if needed
          ...
          handleTextKeyDown={customHandleTextKeyDown} // Use the custom handler
          textInputRef={textInputRef}
          updateText={updateText}
          handleTouchZoom={handleTouchZoom}
          updateTextProperties={updateTextProperties} // Pass the new function
        />
        {selectedFeature === 'quote' && (
          <div
