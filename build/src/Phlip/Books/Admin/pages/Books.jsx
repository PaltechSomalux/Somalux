...
const Books = ({ userProfile }) => {
  ...
  const load = async () => {
    ...
    try {
      ...
      // For editors, filter to only show books they uploaded
      ...
      <div className="panel">
        ...
        <div className="grid-2" style={{ marginBottom: 10 }}>
          <div className="panel">
            ...
            <input className="input" value={search} onChange={(e) => { setPage(1); setSearch(e.target.value); }} placeholder="Search by title..." />
          </div>
          <div className="panel">
            <label className="label">Category</label>
            <select className="select" value={categoryId || ''} onChange={(e) => { setPage(1); setCategoryId(e.target.value || null); }}>
