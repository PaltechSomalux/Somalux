-- ============================================================================
-- Book Comments System
-- ============================================================================
-- This migration creates tables to support book comments, comment likes,
-- and comment replies. It includes RLS policies for security.
--
-- Tables:
--   - book_comments: Main comment table
--   - book_comment_likes: Track likes on comments
--   - book_replies: Track replies to comments
-- ============================================================================
