      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
        <div>
          ...
          <div style={{ color: '#8696a0', fontSize: 12, marginTop: 4 }}>
            Review submissions (papers, features, complaints, feedback)
          </div>
        </div>
      </div>
              ...
              <div style={{ background: '#0a0e11', borderRadius: 4, border: '1px solid #263238', overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
                ...
                {filtered.pageItems.map((r, idx) => (
                  ...
                  >
                    ...
                    {/* Type Column */}
                    <div style={{ fontSize: 11, fontWeight: 600, color: r.type === 'feature' || r.type === 'features' ? '#a78bfa' : r.type === 'complaint' ? '#f97316' : r.type === 'feedback' ? '#ec4899' : '#64748b', textAlign: 'center', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {r.type === 'feature' || r.type === 'features' ? 'Feature' : r.type === 'complaint' ? 'Complaint' : r.type === 'feedback' ? 'Feedback' : 'Other'}
                    </div>
            ...
            <div style={{ padding: 0 }}>
              ...
              <div style={{ background: '#0b1216', overflow: 'hidden', border: '1px solid #263238', borderRadius: 8 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '70px 150px 120px 180px 110px 110px 120px 1fr', columnGap: 0, borderBottom: '1px solid #263238', alignItems: 'center', minHeight: 56, background: '#071018' }}>
                  ...
                  {/* Type */}
                  <div style={{ padding: '12px 14px', textAlign: 'center', fontSize: 11, fontWeight: 600, color: selected.type === 'pastpaper' ? '#06b6d4' : selected.type === 'feature' ? '#a78bfa' : selected.type === 'complaint' ? '#f97316' : selected.type === 'feedback' ? '#ec4899' : '#64748b' }}>
