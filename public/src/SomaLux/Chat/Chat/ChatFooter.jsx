    ...
    <div className="chat-footer-vibe">
      ...
      <div className="footer-content-container">
        ...
        <div className="footer-content-vibe">
          <button
            className="icon-button-vibe"
            onClick={() => setShowAttachmentOptions(!showAttachmentOptions)}
            aria-label="Attachment options"
            disabled={isRecording}
          >
            <FiPaperclip size={30} color="#ff4444" stroke="#ff4444"/>
          </button>
          ...
          <button
            className={`send-button-vibe ${isRecording ? 'recording' : ''}`}
          ...
          >
            {isRecording ? (
              ...
              <FaMicrophone color="#ff4444" />
            ) : (
              <FaPaperPlane color="#ff4444" />
            )}
          </button>
        </div>
      </div>
