...
export const SportsCanvas = ({
  ...
  }, [image, imageDimensionsLocal, logos, setLogos, selectedFeature, additionalImages, isMatchday, isPaltechDeleted]);
            ...
            prevLogos.map((logo) =>
              logo.id === 'paltechWhite'
                ? {
                    ...
                    x: 10 + logo.width / 2,
                    y: 10 + logo.height / 2,
                    width: (isMatchday || selectedFeature === 'quote' ? 50 : 100) / 2,
                    height: (isMatchday || selectedFeature === 'quote' ? 50 : 100) / 2,
                  }
                : logo
            )
          );
