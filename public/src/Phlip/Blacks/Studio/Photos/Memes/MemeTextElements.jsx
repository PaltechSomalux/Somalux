...
import './Memes.css'; // Ensure CSS is imported for custom styles

export const MemeTextElements = ({
  texts,
  setTexts, // Added prop for direct state updates
  activeElement,
  isEditing,
  textStyles,
  textColor = '#ff0000', // Set red as default text color
  strokeColor,
  fontFamily,
  dragging,
  isRotating,
  ...
  updateText,
  handleTouchZoom,
  updateTextProperties, // New prop for updating text properties (e.g., width, height)
}) => {
  ...
  // Measure text width and height for dynamic sizing
  const measureTextDimensions = (text, fontFamily, fontSize, fontStyle, fontWeight) => {
    ...
    span.textContent = text || ' '; // Ensure non-empty to avoid zero width
            ...
            <input
              ...
              onChange={(e) => {
                if (typeof updateText === 'function') {
                  ...
                  // Update text properties with new dimensions
