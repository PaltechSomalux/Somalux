...
import { useWallpaper } from './defaultwallpapers';
import { defaultWallpapers, wallpaperLibrary } from './defaultwallpapers';
      ...
      <div className="imo-modal" ref={ref}>
        ...
        <div className="imo-preview-area">
          ...
          >
            <div className="imo-chat-preview">
              <div className="imo-message imo-received">Hello there!</div>
              <div className="imo-message imo-sent">Hi! How are you?</div>
            </div>
          </div>
        </div>
        ...
        <div className="imo-wallpaper-selection">
          <div className="imo-wallpaper-scroll">
            ...
            <label className="imo-wallpaper-upload">
              <input
                type="file"
                accept="image/*"
              ...
              <div className="imo-upload-label">Add Photo</div>
            </label>
        ...
        <div className="imo-button-group">
          <button 
