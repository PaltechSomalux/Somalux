...
import './InputAreaChatmeGroups.css';
...
export const InputArea = ({
  ...
  return (
    <div className="input-area-groupChatmeGroups-footer-vibe">
      {showAttachmentOptions && (
        <div className="input-area-groupChatmeGroups-attachment-options-vibe">
          <div className="input-area-groupChatmeGroups-options-grid-vibe">
            <div className="input-area-groupChatmeGroups-option-vibe" onClick={() => handleFileSelection('camera')}>
              <div className="input-area-groupChatmeGroups-option-icon camera-vibe">
                <FaCamera />
              </div>
              <span>Camera</span>
            </div>
            <div className="input-area-groupChatmeGroups-option-vibe" onClick={() => handleFileSelection('gallery')}>
              <div className="input-area-groupChatmeGroups-option-icon gallery-vibe">
                <FaImage />
              </div>
              <span>Gallery</span>
            </div>
            <div className="input-area-groupChatmeGroups-option-vibe" onClick={() => handleFileSelection('document')}>
              <div className="input-area-groupChatmeGroups-option-icon document-vibe">
                <FaFileAlt />
              </div>
              <span>Document</span>
            </div>
            <div className="input-area-groupChatmeGroups-option-vibe" onClick={() => setShowPollModal(true)}>
              <div className="input-area-groupChatmeGroups-option-icon poll-vibe">
                <FaPoll />
              </div>
              <span>Vote</span>
            </div>
            <div className="input-area-groupChatmeGroups-option-vibe">
              <div className="input-area-groupChatmeGroups-option-icon contact-vibe">
                <FaUserCircle />
              </div>
              <span>Contact</span>
            </div>
            <div className="input-area-groupChatmeGroups-option-vibe">
              <div className="input-area-groupChatmeGroups-option-icon location-vibe">
                <FaMapMarkerAlt />
              </div>
              <span>Location</span>
            </div>
      ...
      <div className="input-area-groupChatmeGroups-footer-content-container">
        <div className="input-area-groupChatmeGroups-footer-content-vibe">
          <button
            className="input-area-groupChatmeGroups-icon-button-vibe"
          ...
          {isReplying ? (
            <div className="input-area-groupChatmeGroups-reply-input-container">
              {editingMessage && (
              ...
              <div className="input-area-groupChatmeGroups-reply-preview">
                <div className="input-area-groupChatmeGroups-reply-content">
                  <span className="input-area-groupChatmeGroups-reply-sender">
                    {replyingTo.sender === currentUser?.id ? 'You' : (contact?.name || 'Someone')}
                  </span>
                  <span className="input-area-groupChatmeGroups-reply-text" style={{ whiteSpace: 'pre-wrap' }}>
                    {replyingTo.text || '[Media]' || '\u00A0'}
                  </span>
                </div>
                <button
                  className="input-area-groupChatmeGroups-reply-cancel-button"
              ...
              <div className="input-area-groupChatmeGroups-message-input-section">
                <textarea
                  ref={inputRef || textareaRef}
                  className="input-area-groupChatmeGroups-message-input-vibe"
            ...
            <div className="input-area-groupChatmeGroups-input-wrapper" style={{ flex: 1, maxWidth: 'calc(100% - 98px)' }}>
              {editingMessage && (
                <div className="input-area-edit-banner">
                  <div className="input-area-edit-label">Editing message</div>
                  <button
          ...
          <button
            className={`input-area-groupChatmeGroups-send-button-vibe ${voiceNoteRecording ? 'recording' : ''}`}
