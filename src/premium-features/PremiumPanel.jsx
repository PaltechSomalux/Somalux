...
function PremiumPanel({ onClose, onSelectPlan }) {
  ...
  const handleChoose = () => {
    ...
    if (selectedPlan && (selectedPlan === 'premium' || selectedPlan === 'pro')) {
      // Show subscription modal for premium plans
  ...
  const handleSubscribed = (subscriptionData) => {
    // Handle successful subscription
    console.log('Subscription successful:', subscriptionData);
    setShowSubscriptionModal(false);
    onClose(); // Close the premium panel
    if (onSelectPlan) {
  ...
  return (
    ...
    {/* Subscription Modal - Outside wrapper so it can be visible independently */}
    <SubscriptionModal
