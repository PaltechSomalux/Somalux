          ...
          <div className="avatar clickable">
            { (message?.senderImage || (senderInfo && senderInfo.photoURL)) && !avatarFailed ? (
              ...
              <span 
                ...
                style={{ background: getAvatarColor(message.senderName || (senderInfo && senderInfo.displayName) || 'User') }}
                title={message.senderName || (senderInfo && (senderInfo.displayName || senderInfo.email)) || 'User'}
              >
                {(message.senderName || (senderInfo && (senderInfo.displayName || senderInfo.email)) || 'U').charAt(0).toUpperCase()}
              </span>
            )}
